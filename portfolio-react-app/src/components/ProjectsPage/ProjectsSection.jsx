...
function ProjectSection() {
    const projects = [
            {id: "portfolio", title: "Portfolio Website", date: "Dec 2025 - Feb 2026 | React, Vite, JavaScript, HTML, CSS", description: <p>Designed and developed a personal portfolio website to showcase projects, technical skills and learn front-end development. Focused on a component-based structure and responsive design.</p>, color: "purple", image: portfolioImg,},
