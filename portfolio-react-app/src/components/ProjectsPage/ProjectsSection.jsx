...
function ProjectSection() {
    const projects = [
            ...
            {id: "galaga",title: "Star Swarm", date: "Sept 2024 - Oct 2024 | Processing (Java), Piskel", description: <p>Developed a three-level Galaga-style 2D game in Processing as part of the CGRA151 course. Implemented physics-based movement and object-oriented programming. Designed and created all original sprites used in the game.</p>,color: "blue",},
