...
function ProjectSection() {
    const projects = [
            {id: "portfolio", title: "Portfolio Website", date: "Dec 2025 - Feb 2026 | React, Vite, JavaScript, HTML, CSS", description: <p>Designed and developed a personal portfolio website to showcase projects, technical skills and learn front-end development. Focused on a component-based structure and responsive design.</p>, color: "pink",},
            ...
            {id: "chips",title: "Fash and Chaps", date: "Sept 2025 - Oct 2025 | Java, JUnit, GitLab", description: <p>Worked in a team of six to develop a game inspired by Chip’s Challenge as part of the SWEN225 course. Designed and implemented the core game logic using a structured object-oriented architecture and applied multiple design patterns.</p>,color: "green",},
            {id: "recapp",title: "Recapp", date: "VUW Hackathon 2025 | TypeScript, JavaScript, GitHub", description: <p>Worked in a team of six to develop a private app for connecting with close friends and family, allowing users to share memories without the pressure of social media. Contributed to concept design and project presentation, while supporting teammates in development.</p>,color: "green",},
            {id: "galaga",title: "Star Swarm", date: "Sept 2024 - Oct 2024 | Processing (Java), Piskel", description: <p>Developed a three-level Galaga-style 2D game in Processing as part of the CGRA151 course. Implemented physics-based movement and object-oriented programming. Designed and created all original sprites used in the game.</p>,color: "green",},
            {id: "avc",title: "Automated Vehicle Challenge", date: "May 2024 - June 2024 | C++, Raspberry Pi, Linux", description: <p>Worked in a team of four to build and code a line-following robot to complete a course uninterrupted as part of the ENGR101 course. Coordinated team activities to manage time effectively and supported teammates, while focusing on testing and debugging.</p>,color: "green",},
          ];
